...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
        ...
        if ((isGrounded && Input.GetButtonDown("Jump")) || (_canDoubleJump && Input.GetButtonDown("Jump"))) // If grounded AND jump button pressed, then allow the player to jump
		{
            DoJump();
        ...
        } else if (isGrounded) // When we return to grounded reset the double jump and the gravity scale 
